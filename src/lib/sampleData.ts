...
export const DEFAULT_CONTRACT: Contract = {
  ...
  milestone_payment: 12500,
  total_contract_value: 150000,
  total_required_minutes: 1080,
...
export const INITIAL_SAMPLE_VIDEOS: Video[] = [
  ...
  },
  {
    ...
    duration_seconds: 1590, // 26m 30s -> Current Total: 248m 02s (Milestone 3 progress: 68m 02s / 90m = 75.6%, 21m 58s remaining for next ৳12,500!)
